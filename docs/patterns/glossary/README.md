...
eq<Int>()
// arrow.instances.IntEqInstance@23aca0d6
```
...
// arrow.data.ListKApplicativeInstanceImplicits$instance$1@701695cb
```
...
// arrow.core.OptionApplicativeInstanceImplicits$instance$1@52b30b94
```
