...
// arrow.core.OptionMonadErrorInstanceImplicits$instance$1@42b47c3
```

```kotlin
monadError<ForTry, Throwable>()
// arrow.data.TryMonadErrorInstanceImplicits$instance$1@1a2be0bc
```

```kotlin
monadError<EitherPartialOf<NukeException>, NukeException>()
// arrow.core.EitherMonadErrorInstanceImplicits$instance$1@15ea20e2
```
